...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(prog='bert-sa')
...
# %%
up_task_id = 'GYdeaG3JCmMLSG4njOL98Ja8ebH1QxeH'
...
upmodel.load_state_dict(torch.load(
    f"{proj_root_dir}/lib/StructurePrediction/SA/{up_task_id}/model.pt", map_location=torch.device('cpu')))
