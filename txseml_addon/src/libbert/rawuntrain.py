...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(prog='bert-rawcode-untrain')
...
max_length = 126 + 2
# %%
model = BertModel.from_pretrained("/mnt/md0/Public/T3_T4/txseml_addon/data/bert", )
f_tokenizer = BertTokenizer.from_pretrained("/mnt/md0/Public/T3_T4/txseml_addon/data/bert")
    ...
    with torch.no_grad():
        for index, dataset in enumerate(data_loader):
            ...
            predictions = np.concatenate(
                (predictions, ss_output.last_hidden_state),
                axis=0
            )
