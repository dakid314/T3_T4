...
LastEditTime: 2022-02-01 14:30:09
Description: 
...
logger = utils.glogger.Glogger('SC_PseAAC_data_submiter', os.path.join(
...
def Submit_to_server(seq_fastaFormat: str):
    ...
    while resp.status_code is None or resp.status_code != 200:
        try:
            with requests.Session() as s:
                resp = s.post(
                    'http://bliulab.net/Pse-in-One/PROTEIN/SC-PseAAC/',
                    data=mp_encoder,
                    headers={
...
if __name__ == '__main__':
    # # %% T1 #################################################
    # # Traning
    # T4se_fasta = get_feature(
    #     os.path.join(
    #         work_Dir, 'data/db/T1/t_p.fasta')
    # )

    # no_T4se_fasta = get_feature(
    #     os.path.join(
    ...
    #     'data': {
    #         'T1se': T4se_fasta,
    #         'no_T1se': no_T4se_fasta
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T1/data/SC_PSEACC_data_t.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T1/data/SC_PSEACC_data_v.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    #     'data': {
    #         'T2se': T4se_fasta,
    #         'no_T2se': no_T4se_fasta
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T2/data/SC_PSEACC_data_t.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T2/data/SC_PSEACC_data_v.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    #     'data': {
    #         'T3se': T4se_fasta,
    #         'no_T3se': no_T4se_fasta
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T3/data/SC_PSEACC_data_t.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    #     },
    # }
    # with open(os.path.join(out_Dir, 'T3/data/SC_PSEACC_data_v.json'), 'w+', encoding='UTF-8') as f:
    #     json.dump(
    #         final_dataset_dict,
    #         f
    #     )
    ...
    final_dataset_dict = {
        'data': {
            'T4se': T4se_fasta,
            'no_T4se': no_T4se_fasta
        },
    }
    with open(os.path.join(out_Dir, 'T4/data/SC_PSEACC_data_t.json'), 'w+', encoding='UTF-8') as f:
        json.dump(
            final_dataset_dict,
            f
        )
    ...
    with open(os.path.join(out_Dir, 'T4/data/SC_PSEACC_data_v.json'), 'w+', encoding='UTF-8') as f:
        json.dump(
            final_dataset_dict,
            f
        )
    ...
    final_dataset_dict = {
        'data': {
            'T6se': T4se_fasta,
            'no_T6se': no_T4se_fasta
        },
    }
    with open(os.path.join(out_Dir, 'T6/data/SC_PSEACC_data_t.json'), 'w+', encoding='UTF-8') as f:
        json.dump(
            final_dataset_dict,
            f
        )
    ...
    with open(os.path.join(out_Dir, 'T6/data/SC_PSEACC_data_v.json'), 'w+', encoding='UTF-8') as f:
        json.dump(
            final_dataset_dict,
            f
        )
