...
def BPBaac(pos_file, neg_file, output_file,cter):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        for seq_record in fasta_sequences:
            ...
            mapped_values = [protein_id] + BPBaac_psp.mat_mapper(processed_sequence, pmat, nmat, cter=cter)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', type=str, required=True, help='cter.')
    args = parser.parse_args()

    BPBaac(pos_file=args.p, neg_file=args.n, output_file=args.o,cter=args.c)