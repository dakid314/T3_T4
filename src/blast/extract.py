...
rate = 70
pro_type = ['T1','T2','T3','T4','T6','T5'][2]
pos_fasta_file = f"/mnt/md0/Public/T3_T4/data/new_{pro_type}/pos/{pro_type}_training_{rate}.fasta"
a = 0
neg_fasta_file = f"/mnt/md0/Public/T3_T4/data/new_{pro_type}/neg/all_n{pro_type}_{rate}.fasta"
...
while a < 5: 
    ...
    for num in  lst:          
        ...
        output_folder = f'/mnt/md0/Public/T3_T4/data/new_{pro_type}/{rate}/{a}'
