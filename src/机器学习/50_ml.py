...
rate_list = ['1_1','1_10','1_30','1_50','1_80','1_100']#'1_1','1_10','1_30','1_50','1_80',
for feature_name in feature_list:
    for rate in rate_list:
        a = 0
        while a < 5:
            if feature_name in ['SC-PseAAC', 'PC-PseAAC']:
                neg_df = pd.read_csv(f'/mnt/md0/Public/T3_T4/txseml_addon/out/libfeatureselection/feature_research_neg/{feature_name}/{a}/all_nT3_50_{rate}.fasta.csv', header=None)
                pos_df = pd.read_csv(f'/mnt/md0/Public/T3_T4/txseml_addon/out/libfeatureselection/feature_research_pos/T3_training_50.fasta_{feature_name}.csv', header=None)
            else:
                neg_df = pd.read_csv(f'/mnt/md0/Public/T3_T4/txseml_addon/out/libfeatureselection/feature_research_neg/{feature_name}/{a}/all_nT3_50_{rate}.fasta.csv')
                pos_df = pd.read_csv(f'/mnt/md0/Public/T3_T4/txseml_addon/out/libfeatureselection/feature_research_pos/T3_training_50.fasta_{feature_name}.csv')
            if feature_name == 'BPBaac':
                feature = pd.read_csv(f'/mnt/md0/Public/T3_T4/txseml_addon/out/libfeatureselection/feature_research_neg/{feature_name}/{a}/all_nT3_50_{rate}.fasta.csv')
            ...
            model_path_to_save = f'/mnt/md0/Public/T3_T4/model/50_model/{feature_name}/{rate}/{a}'
