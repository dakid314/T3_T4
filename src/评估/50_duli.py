...
for bac_name in bac_name_:
    for stand in stand_:
        ...
        for feature_name in feature_name_list:
            batch = 0
            while batch <5:
                for model_name in ["KNeighborsClassifier",]:
                    for rate in rate_list:
                        model_save_dir = f"/mnt/md0/Public/T3_T4/model/50_model/{feature_name}/{rate}/{batch}"
...
df.to_excel(f'50_duli.xlsx', index=False)