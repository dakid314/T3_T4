...
import os
feature_name_list = ['18pp','AAC','BPBaac','CTDC','CTDT','CTriad','CTDD','DPC','onehot',
...
bac_name = ['Ralstonia_pseudosolanacearum_GMI1000','Salmonella_LT2',
            'new_Pseudomonas_aeruginosa_PAO1','new_Burkholderia_mallei_ATCC_23344',
            'new_Pseudomonas_sp.MIS38','Coxiella_burnetii_RSA_331'][5]
stand_ = ['lossen','strict']

bac_type = ['T3','T4','T1','T2','T6'][1]
...
for cd_hit in cd_hit_:
    ...
    path = f'/mnt/md0/Public/T3_T4/评估/{bac_type}'
    os.makedirs(path, exist_ok=True)
    df.to_excel(f'{path}/{bac_type}_{cd_hit}_duli.xlsx', index=False)